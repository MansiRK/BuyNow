class Products {
	...
	// 			$(data).each(function (index, product) {
	// 				$(".products").append(
	// 					'<div class="col-md-3"><div class="newproduct"><a href="/bestseller.html?productid=' +
	// 						encodeURIComponent(product.id) +
	// 						'">' +
	// 						'<div class="image"><img src="' +
	// 						product.image +
	...
	getSingleProduct(id) {
		$.ajax({
			...
			success: function (data) {
				...
				$(".product_price").html("Price: $" + data.price.toFixed(2));
				$(".product_description").html("<p> <b>Description:</b> " + data.description + "</p>");
			},
		});
	}
}
